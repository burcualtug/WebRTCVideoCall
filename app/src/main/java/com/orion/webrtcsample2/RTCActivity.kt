...
class RTCActivity : AppCompatActivity() {
    ...
    //burda butonların kontrolunu yapıyoruz (mic ac kapa vs.)
    ...
    //sinyal istemcisi objecti yarattik arama baslamasi oldugu icin end call'ı da clickable yaptik
    private fun createSignallingClientListener() = object : SignalingClientListener {
        ...
        override fun onOfferReceived(description: SessionDescription) {
            ...
            Constants.isIntiatedNow = false //simdi baslatildiyi false yaptik
            rtcClient.answer(sdpObserver,meetingID)
            remote_view_loading.isGone = true
        }

        //answer alindiginda medyatik iletisim icin sessiondescription protokolunu devreye sokuyoruz
        ...
        //ice candidate alindiginda ekliyoruz
