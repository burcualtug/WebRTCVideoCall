...
import com.orioninnovation.tr.oiwebrtc.*
...
class RTCClient(
    ...
    //creating peer connection and video capturer
    ...
    private fun PeerConnection.call(sdpObserver: SdpObserver, meetingID: String) {
        ...
        //sdp observer is a public interface of webrtc
        //creating createoffer object then printing success or failure messages
            ...
            override fun onCreateSuccess(desc: SessionDescription?) {
                setLocalDescription(object : SdpObserver {
                    ...
                    override fun onSetSuccess() {
                        ...
                        //A DocumentSnapshot Firestore veritabanınızdaki bir belgeden okunan verileri içerir.
    ...
    //session description bir webrtc protocoludur. medya iletisim oturumlarini tanimlar. direkt medya alisverisi yapmaz ama saglar
    fun onRemoteSessionReceived(sessionDescription: SessionDescription) {
        remoteSessionDescription = sessionDescription
        peerConnection?.setRemoteDescription(object : SdpObserver {
            //buralarda durum mesajlarini printliyoruz
            override fun onSetFailure(p0: String?) {
                Log.e(TAG, "onSetFailure: $p0")
            }
